...
int main(void) {
    ...
    ALLEGRO_SAMPLE * samples[SAMPLES]={NULL,NULL,NULL,NULL};//arreglo de canciones , para saber cuantas hay que iniciar.
    ALLEGRO_BITMAP* display_background[BACKGROUNDS]={NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL};// arreglo para incluir fondos.
